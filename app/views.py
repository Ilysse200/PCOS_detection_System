...
def results(request):
    ...
    result_msg = ''
    if ans == 0:
        result_msg = 'Based on the information provided, it is unlikely that you have PCOS.'
    else:
       result_msg = 'Based on the information provided, it is likely that you have PCOS.'
